  ...
  for (i in 1: length(participants)){
    ...
    if( !is.null(nrow(pardata))){
      ...
      for (j in seq(1,ncol(visualdata),3)){
        newdf <- as.data.frame(filtervisuals(visualdata[,(j:(j+2))],aois,5))
...
savedataA(newtimetoFix[[1]],newtimetoFix[[2]],newtimetoFix[[3]],newtimetoFix[[4]],"Stats_AllFix3.xls")
savedataA(newtimetoFixTYP[[1]],newtimetoFixTYP[[2]],newtimetoFixTYP[[3]],newtimetoFixTYP[[4]],"Stats_AllTYPFix3.xls")
savedataA(newtimetoFixASD[[1]],newtimetoFixASD[[2]],newtimetoFixASD[[3]],newtimetoFixASD[[4]],"Stats_AllASDFix3.xls")
save(newtimetoFix,newtimetoFixTYP,newtimetoFixASD,file = paste(getwd(),"/Master RDA files_RG/HeatmapdataFixA.rda",sep=""))
