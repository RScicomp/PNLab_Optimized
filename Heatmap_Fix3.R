...
savedataI <- function(dFF,dFS,dSF,dI){
  ...
  writetoExcel(datalist, paste(getwd(),"/ASD Stats/asdFixStats_Incorrect.xls",sep=""),conditions)
...
savedataC <- function(dFF,dFS,dSF,dI){
  ...
  writetoExcel(datalist, paste(getwd(),"/ASD Stats/asdFixStats_Correct.xls",sep=""),conditions)
  writetoCSV(datalist, conditions)
}
savedataA <- function(dFF,dFS,dSF,dI){
  ...
  # writetoExcel(list(CorrectstatsFF, CorrectstatsFS, CorrectstatsSF, CorrectstatsI), "instatsrawdata.xls", conditions)
  writetoExcel(datalist, paste(getwd(),"/ASD Stats/asdFixStats_All.xls",sep=""),conditions)
  writetoCSV(datalist, conditions)
}
savedataItyp <- function(dFF,dFS,dSF,dI){
  ...
  # writetoExcel(list(incorrectstatsFF, incorrectstatsFS, incorrectstatsSF, incorrectstatsI), "instatsrawdata.xls", conditions)
  writetoExcel(datalist, paste(getwd(),"/TYP Stats/TypFixStats_Incorrect.xls",sep=""),conditions)
  writetoCSV(datalist, conditions)
}
savedataCtyp <- function(dFF,dFS,dSF,dI){
  ...
  # writetoExcel(list(CorrectstatsFF, CorrectstatsFS, CorrectstatsSF, CorrectstatsI), "instatsrawdata.xls", conditions)
  writetoExcel(datalist, paste(getwd(),"/TYP Stats/TypFixStats_Correct.xls",sep=""),conditions)
  writetoCSV(datalist, conditions)
}
savedataAtyp <- function(dFF,dFS,dSF,dI){
  ...
  # writetoExcel(list(CorrectstatsFF, CorrectstatsFS, CorrectstatsSF, CorrectstatsI), "instatsrawdata.xls", conditions)
  writetoExcel(datalist, paste(getwd(),"/TYP Stats/TypFixStats_All.xls",sep=""),conditions)
  writetoCSV(datalist, conditions)
}
...
file <- file.choose()
load(paste(getwd(),"/Master RDA files_RG/HeatmapdataFixC.rda",sep=""))
load(paste(getwd(),"/Master RDA files_RG/HeatmapdataFixI.rda",sep=""))
load(paste(getwd(),"/Master RDA files_RG/HeatmapdataFixA.rda",sep=""))
...
if (user.input == "yes"){
  ...
  save(behaveFF,behaveFS,behaveSF,behaveI,datatrialFF,datatrialFFI,datatrialFFC,datatrialFS,datatrialFSI,datatrialFSC,datatrialSF,datatrialSFI,datatrialSFC,datatrialI,datatrialII,datatrialIC,names, file = "Master RDA files_RG/DataforHeatmapFix3.rda")
  
}else{load("Master RDA files_RG/DataforHeatmapFix3.rda")}
