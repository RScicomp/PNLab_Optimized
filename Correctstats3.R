...
savedataA(newtimetoFixC[[1]],newtimetoFixC[[2]],newtimetoFixC[[3]],newtimetoFixC[[4]],"Stats_Correct3.xls")
savedataA(newtimetoFixTYPC[[1]],newtimetoFixTYPC[[2]],newtimetoFixTYPC[[3]],newtimetoFixTYPC[[4]],"Stats_CorrectTYP3.xls")
savedataA(newtimetoFixASDC[[1]],newtimetoFixASDC[[2]],newtimetoFixASDC[[3]],newtimetoFixASDC[[4]],"Stats_CorrectASD3.xls")
save(newtimetoFixC,newtimetoFixTYPC,newtimetoFixASDC,file = paste(getwd(),"/Master RDA files_RG/HeatmapdataC.rda",sep=""))
