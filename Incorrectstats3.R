...
savedataA(newtimetoFixI[[1]],newtimetoFixI[[2]],newtimetoFixI[[3]],newtimetoFixI[[4]],"Stats_Incorrect3.xls")
savedataA(newtimetoFixTYPI[[1]],newtimetoFixTYPI[[2]],newtimetoFixTYPI[[3]],newtimetoFixTYPI[[4]],"Stats_IncorrectTYP3.xls")
savedataA(newtimetoFixASDI[[1]],newtimetoFixASDI[[2]],newtimetoFixASDI[[3]],newtimetoFixASDI[[4]],"Stats_IncorrectASD3.xls")
save(newtimetoFixI,newtimetoFixTYPI,newtimetoFixASDI,file = paste(getwd(),"/Master RDA files_RG/HeatmapdataI.rda",sep=""))
